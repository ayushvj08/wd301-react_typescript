...
export function LabellebInput(props: { key: Number, id: number, value: any, label: string, fieldtype: string, removeFieldCB: (id: number) => void, passValueCB: (value: string, id: number) => void }) {
